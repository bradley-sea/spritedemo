...
@property (strong,nonatomic) NSArray *gameInfoOptions;
...
- (void)viewDidLoad
{
    ...
    self.gameInfoOptions  = @[@"Home Team", @"Away Team", @"Date",@"Time",@"Forecast"];
    
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"gameCell"];
    
    self.preferredContentSize = CGSizeMake(300, 230);
...
#warning Incomplete method implementation.
    ...
    return self.gameInfoOptions.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = self.gameInfoOptions[indexPath.row];
